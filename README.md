...
**Faz 0 completed** — 31/31 opcodes production-ready, full AIR constraint coverage, 51 tests (8 negative), 0 failures.
...
| `bud-compiler` | BudL compiler: lexer, recursive-descent parser, semantic analysis, codegen |
